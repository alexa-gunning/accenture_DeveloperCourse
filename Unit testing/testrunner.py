...
def test_psw_equal3():
  pwd1 = "Qwerty$£@55"
  pwd2 = "Qwerty$£@"
  assert check_psw_equal(pwd1, pwd2) is False
...
def test_check_credentials1():
  ...
  pwd1 = "Qwerty$£@55"
  pwd2 = "Qwerty$£@55"
  assert check_credentials(email, pwd1, pwd2) is True
